...
export function designWorkflow(
  ...
  const baseStates: Record<PatternName, any[]> = {
    approval_workflow: [
      ...
      { name: "Pending Approval", color: "#2968A8", ai_hint: "" },
      { name: "Approved", color: "#1E6B45", ai_hint: "" },
      { name: "Rejected", color: "#8B2D2D", ai_hint: "" },
    ],
    ticket_management: [
      { name: "New", color: "#5A6070", initial: true, ai_hint: "" },
      { name: "Triaged", color: "#2968A8", ai_hint: "" },
      { name: "In Progress", color: "#2A7B50", ai_hint: "" },
      { name: "Resolved", color: "#1E6B45", ai_hint: "" },
      { name: "Closed", color: "#1E6B45", ai_hint: "" },
    ],
    multi_stage_pipeline: [
      { name: "Not Started", color: "#5A6070", initial: true, ai_hint: "" },
      { name: "In Progress", color: "#2A7B50", ai_hint: "" },
      { name: "Review", color: "#2968A8", ai_hint: "" },
      { name: "Completed", color: "#1E6B45", ai_hint: "" },
      { name: "Cancelled", color: "#8B2D2D", ai_hint: "" },
    ],
    record_list: [],
  };
  ...
  const baseActivities: Record<PatternName, any[]> = {
    approval_workflow: [
      { name: "Submit", actor: "hybrid", fields: [], ai_hint: "", confidence_threshold: 0 },
      { name: "Approve", actor: "human", fields: [], ai_hint: "", confidence_threshold: indDefaults.confidence_threshold },
      { name: "Reject", actor: "human", fields: [], ai_hint: "", confidence_threshold: 0 },
    ],
    ticket_management: [
      { name: "Triage", actor: "hybrid", fields: [], ai_hint: "", confidence_threshold: 0 },
      { name: "Assign", actor: "human", fields: [], ai_hint: "", confidence_threshold: 0 },
      { name: "Resolve", actor: "human", fields: [], ai_hint: "", confidence_threshold: 0 },
      { name: "Close", actor: "human", fields: [], ai_hint: "", confidence_threshold: 0 },
    ],
    multi_stage_pipeline: [
      { name: "Start", actor: "human", fields: [], ai_hint: "", confidence_threshold: 0 },
      { name: "Submit for Review", actor: "hybrid", fields: [], ai_hint: "", confidence_threshold: 0 },
      { name: "Complete", actor: "human", fields: [], ai_hint: "", confidence_threshold: 0 },
      { name: "Cancel", actor: "human", fields: [], ai_hint: "", confidence_threshold: 0 },
    ],
    record_list: [],
  };
